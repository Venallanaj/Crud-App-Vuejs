<template>
  <b-form class="mt-3">
    ...
    <b-row class="mt-3">
      ...
      <b-col cols="6">
        <b-form-group id="zipcode" label="Zip Code" label-for="Zip Code">
          <b-form-input
            id="zipcode"
            type="text"
    ...
    <div class="btn-save mt-4 mb-4" style="float: right">
...
export default {
  ...
  methods: {
    ...
    showPosition(position) {
      this.user.address.geo.lat = position.coords.latitude;
      this.user.address.geo.lng = position.coords.longitude;
    },
    onlyNumber($event) {
